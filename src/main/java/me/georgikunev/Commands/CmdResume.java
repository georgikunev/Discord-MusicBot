...
public class CmdResume implements CmdBot {
    ...
    public void execute(ExecArgs executeArgs) {
        ...
        if (audioPlayer.getPlayingTrack() == null){
            ...
            executeArgs.getTextChannel().sendMessage("The track is already playing.").complete();
            return;
        }
        guildMusicManager.trackScheduler.audioPlayer.setPaused(false);
        executeArgs.getTextChannel().sendMessage("Track running").complete();
    }
